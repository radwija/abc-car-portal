...
<footer class="text-center text-lg-start bg-light text-muted mt-5">
			...
			<div class="row mt-3">
				...
				<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
					...
					<h6 class="text-uppercase fw-bold mb-4">
						<i class="fas fa-gem me-3"></i>ABC Car Portal
					</h6>
					<p>We provide user with a range of local used cars in Malaysia listed at 
				an affordable and negotiable price.
					</p>
				</div>
				<!-- Grid column -->
				...
				<div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
					...
					<p>
						<i class="fas fa-home me-3"></i> Malaysia, MY 10012, MY
					</p>
					<p>
						<i class="fas fa-envelope me-3"></i> contact@abccar.com
					</p>
					<p>
	...
	<div class="text-center p-4"
		...
		&copy; 2022 Copyright: <a class="text-reset fw-bold"
			href="https://mdbootstrap.com/">ABCar.com</a>
	</div>
	<!-- Copyright -->
</footer>
<!-- Footer -->