						...
						<div class="container mb-5">
							<div class=" mb-5">
								<div class="row g-0">
									...
									<div class="col-md-6 shadow-sm" style="border-radius: 15px;">
											...
											<c:if test="${sellStatus != 'sold'}">
												...
												<div class="buttons d-flex flex-row mt-5 gap-3">
													...
													<button type="button" class="btn btn-light" data-bs-toggle="modal"
														data-bs-target="#exampleModal1" style="width: 500px;">Book for
														Test Drive</button>
														...
														<div class="modal-dialog">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title" id="exampleModal1Label">Book
																		for
																		Test Drive</h5>
																...
																<div class="modal-body">
																	...
																	<!-- Book Form -->
																	<sf:form action="book" method="post"
																		class="was-validated" modelAttribute="booking">
																		<div class="mb-3 mt-3">
																			<label for="bookDate"
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<!-- Bid Form -->
																	<sf:form action="bid" method="post"
																		class="was-validated" modelAttribute="bidding">
																		<div class="mb-3 mt-3">
																			<label for="name" class="form-label">Bid
																				Price
																				(Rp):</label> <input type="text"
																				class="form-control"
										...
										<table class="table table-bordered">
											<thead>
												<tr>
													...
													<th scope="col">Bidding Price (Rp)</th>
